...
<body class="min-h-screen flex items-center justify-center p-4">
    <div class="bg-white w-full max-w-4xl rounded-xl shadow-lg grid grid-cols-1 md:grid-cols-2 overflow-hidden">
        ...
        <div class="flex flex-col justify-center px-6 py-8 md:px-14 md:py-12">
            <h2 class="text-2xl font-bold mb-6 md:mb-8 text-center">Create Account</h2>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-4">
                    ...
                    <input 
                        ...
                        value="{{ old('name') }}"
                        required autofocus
                        class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent transition"
                    />
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input 
                            ...
                            placeholder="••••••••••••••••"
                            required
                            class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent transition pr-10"
                        />
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <input 
                            ...
                            class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent transition pr-10"
                        />
                        <button type="button" id="toggleConfirmPassword" class="absolute right-3 top-3 text-gray-500 hover:text-gray-700 transition">
                            <i class="far fa-eye"></i>
                        </button>
                    </div>
