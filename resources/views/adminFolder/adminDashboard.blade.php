...
<body class="bg-gray-50">
                ...
                <div class="detail-card bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <div class="space-y-2">
                        ...
                        <!-- <div class="detail-item flex justify-between items-center">
                            ...
                            <span class="font-bold text-yellow-600" id="maintenance-count">0</span>
                        </div> -->
                        <div class="detail-item flex justify-between items-center">
    ...
    <script>
        ...
        function populateDashboard(data) {
            ...
            // document.getElementById('maintenance-count').textContent = data.units.maintenance;
